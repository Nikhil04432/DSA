...
private:
    ...
    DictNode* removeNode(DictNode* node, const string& key) {
        ...
        if (result < 0) {
            ...
            if (node->left == nullptr) {
                ...
                removeNodeFromInsertionOrder(node); // Remove node from insertionOrder
                delete node;
                return temp;
    ...
    void removeNodeFromInsertionOrder(DictNode* node) {
...
int main() {
    ...
    do {
        ...
        cout << "5. Display dictionary (ascending/descending)\n";
        cout << "6. Exit\n";
